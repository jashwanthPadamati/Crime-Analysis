# -*- coding: utf-8 -*-
"""
Created on Sun Sep 22 01:39:31 2019
...
crimes1 = pd.read_csv('C:/Users/Admin/Documents/Crime Analysis/42_District_wise_crimes_committed_against_women_2006_2017.csv')
crimes2 = pd.read_csv('C:/Users/Admin/Documents/Crime Analysis/42_District_wise_crimes_committed_against_women_2018.csv')
...
crimes_total_2006 = crimes_total[crimes_total['Year'] == 2006]
crimes_total_2006.drop('Year', axis=1, inplace=True)

# Data of Rape crime committed in the year 2001 per state
x = crimes_total_2006['STATE'].values
y = crimes_total_2006['Rape'].values

# plot the bar graph
fig, ax = plt.subplots()
crime_rape = crimes_total_2006['STATE'].values
y_pos = np.arange(len(crime_rape))
performance = crimes_total_2006['Rape'].values
...
plt.show()
plt.savefig('Rape vs State', bbox_inches='tight')


# Any results you write to the current directory are saved as output.
# creating a new data set

crimes_total_women1 = pd.read_csv('C:/Users/Admin/Documents/Crime Analysis/42_District_wise_crimes_committed_against_women_2006_2017.csv')
crimes_total_women2 = pd.read_csv('C:/Users/Admin/Documents/Crime Analysis/42_District_wise_crimes_committed_against_women_2018.csv')
...
plt.show()
plt.savefig('Crime vs State.png', bbox_inches='tight')